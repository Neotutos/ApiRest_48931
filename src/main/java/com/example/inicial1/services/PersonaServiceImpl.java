...
public class PersonaServiceImpl extends BaseServicesImpl<Persona, Long> implements PersonaService{
    ...
    @Autowired
    private PersonaRepository personaRepository; //acceder desde el rep a todos los metodos
    ...
    public List<Persona> search(String filtro) throws Exception {
        try {
            ...
            //List<Persona> personas = pwrsonaRepository.searchNative(filtro);
            return personas;
        } catch (Exception e) {
    ...
    public Page<Persona> search(String filtro, Pageable pageable) throws Exception {
        try {
            ...
            //Page<Persona> personas = pwrsonaRepository.searchNative(filtro);
            return personas;
        } catch (Exception e) {
            throw new Exception(e.getMessage());
        }
